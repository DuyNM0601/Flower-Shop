    ...
    <body>
        ...
        <section>
            <form action="mainController" method="post" class="form_register">
                <h1>Register</h1>
                <table>
                    <tr><td>Email</td><td><input type="text" name="txtemail" required="" value="<%= (request.getAttribute("txtemail") == null) ? "" : request.getAttribute("txtemail")%>" pattern="^(\\w)+@([a-zA-Z])"></td></tr>
